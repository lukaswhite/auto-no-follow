...
namespace Lukaswhite\AutoNoFollow;

use DOMDocument;
use Lukaswhite\AutoNoFollow\Exceptions\ParserException;

/**
 * Class Processor
 *
 * This class parses HTML and adds rel=nofollow to any links.
 *
 * @package Lukaswhite\AutoNoFollow
 */
class Processor
{
    /**
     * The current host. This is used to determine whether an absolute link is, in fact,
     * actually just the long-form of a relative link.
     *
     * @var string
     */
    ...
    public function addLinks($html, $whitelist = array(), $ignoreRelative = true)
    {
        ...
        try {
            ...
            throw new ParserException('Could not parse the provided HTML.');
        }
